...
# put .runtime/secrets/service_account.json
cp /path/to/service_account.json ./.runtime/secrets/service_account.json

# set OpenAI key
cp .env.example .runtime/.env
nano .runtime/.env
# no need to source; env_bootstrap auto-loads .runtime/.env
